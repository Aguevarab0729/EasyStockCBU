<div class="container pb-6 pt-6">
    <div class="container is-fluid mb-6">
        <div class="columns is-vcentered">
            <div class="column">
                <h2 class="title">Productos por categoría</h2>
            </div>
            <div class="column">
                <a href="index.php?vista=category_search" class="button is-link is-inverted" style="float: right;">
                    <span class="icon">
                        <i class="fas fa-search"></i>
                    </span>
                    <span>Categoría</span>
                </a>
                <a href="index.php?vista=product_search" class="button is-link is-inverted" style="float: right;">
                    <span class="icon">
                        <i class="fas fa-search"></i>
                    </span>
                    <span>Productos</span>
        ...
        <div class="columns">
            <div class="column is-one-third">
                <h2 class="title is-4 has-text-centered">Categorías</h2>
                <?php
                    $categorias=conexion();
            ...
            <div class="column">
                <?php
                    ...
                    if($check_categoria->rowCount()>0){
                        ...
                        echo '
                            <h2 class="title is-4 has-text-centered">'.$check_categoria['categoria_nombre'].'</h2>
