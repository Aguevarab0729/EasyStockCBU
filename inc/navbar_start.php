        ...
        <div class="navbar-end">
            <div class="navbar-item"> 
                <a class="js-modal-trigger button is-ghost" data-target="modal-login">
                    ...
                    <span class="is-family-sans-serif">Iniciar Sesión</span>
                </a>
                ...
                <div id="modal-login" class="modal">
                    ...
                    <div class="modal-card">
                        <header class="modal-card-head">
                            <p class="modal-card-title is-family-sans-serif">Información usuario</p>
                            <button class="delete left" aria-label="close"></button>
                        </header>
                        <section class="modal-card-body">
                            <form class="full-box login" action="" method="POST" autocomplete="off">
                                ...
                                <div class="field">
                                    <label class="checkbox is-family-sans-serif">
                                ...
                                <div class="field is-grouped is-grouped-centered">
                                    <p class="control">
                                        <button class="button btn is-success is-family-sans-serif" type="submit">
                                            Iniciar Sesión
                                        </button>
                                    </p>
                                </div>
